---
title: "The Bacterial Communities Associated with Retting: a Meta-Analysis"
author: "By: qsfl69"
date: "`r Sys.Date()`"
output:
  pdf_document:
...
**Figure 4:** An example of a Principal Component Analysis (PCA) plot from the predicted metagenomes of a retting experiment's samples. Shapes denote the stage of retting and color describes the turning status. Because the PCA was performed globally for each experiment, each graph in the facet can be directly compared.
